...
export default function TestDraftEditorPage() {
    ...
    <div className="bg-pbs-bg-light min-h-screen">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white border border-pbs-gray-200 p-8">
          <div className="mb-6">
            <h1 className="text-3xl font-headline font-bold text-pbs-gray-900 mb-2">
              Test Draft Article Editor
            </h1>
            <div className="bg-blue-50 border border-blue-200 p-4 rounded">
              <p className="text-blue-800 font-sans text-sm">
                <strong>Testing Mode:</strong> This editor uses local file storage and mock AI generation. 
                No MongoDB or OpenAI quota required. Perfect for testing the editing workflow!
              </p>
            </div>
          </div>
            ...
            <div>
              ...
              {!draft ? (
                <div className="border border-pbs-gray-200 p-8 text-center">
                  <p className="text-pbs-gray-500 font-sans">
                    Select a PBS article and generate a mock draft, or load an existing draft to start editing
                  </p>
                </div>
              ) : (
